...
class CriticModel(nn.Module):
    ...
    def __init__(self, input_size, seed, fc1_units=256, fc2_units=256):
        ...
        self.bn1 = nn.BatchNorm1d(fc1_units) #Batch normalisation
        self.reset_parameters()
...
class DoubleAgent(): #Actor_Critic_Models
    '''
    Creates a DoubleAgent class which will create multiple agents for us and modofiy the Critic to allow it to take input from both Actors. 
    '''
